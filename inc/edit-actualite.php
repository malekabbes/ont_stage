...
if (mysqli_query($mysqli,$updateactu)) {
    echo "<script> Swal.fire({position: 'top-end',icon: 'success',title: 'Votre actualité a été bien modifiée',showConfirmButton: false,timer: 1500}).then(function(){window.location.href='actualite.php'});</script>";
  } else {
